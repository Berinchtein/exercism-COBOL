      ...
      * 
       ...
       01 WS-SPECIFIC-U-LETTER-COUNT  PIC 99    VALUE 0.
       01 WS-SPECIFIC-L-LETTER-COUNT  PIC 99    VALUE 0. 
      *
       01 WORK-FIELDS.
          05 TEMP1                    PIC X.
          05 TEMP2                    PIC X.
      ...
      *
       CHECK-LETTER.
           ...
           INSPECT WS-SENTENCE TALLYING WS-SPECIFIC-U-LETTER-COUNT
              FOR ALL TEMP1.
           INSPECT WS-SENTENCE TALLYING WS-SPECIFIC-L-LETTER-COUNT
              FOR ALL TEMP2.
           IF (WS-SPECIFIC-U-LETTER-COUNT > 0
